...
def main(unused_argv):
  ...
  flags.mark_flag_as_required('pipeline_config_path')n
  config = tf.estimator.RunConfig(model_dir=FLAGS.model_dir, keep_checkpoint_max=None, save_checkpoints_steps=1000)
